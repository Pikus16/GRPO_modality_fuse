...
class GRPOModelConfig(ModelConfig):
    ...
    model_name_or_path: str = field(default="Qwen/Qwen3-1.7B", metadata={"help": "Model checkpoint for weights initialization."})
    dna_model_name_or_path: str = field(default="InstaDeepAI/nucleotide-transformer-v2-500m-multi-species", metadata={"help": "Model checkpoint for weights initialization."})
...
def setup_wandb(project='GRPO_FUSE', name='kegg'):
